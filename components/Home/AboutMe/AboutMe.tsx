      ...
      >
        <div className="flex flex-row items-center ">
          ...
          <div className="flex flex-row space-x-2 items-center">
            <span className="text-gray-200 font-bold text-lg sm:text-2xl pl-4">About Me</span>
          </div>
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Chris, and I am a dual degree Computer Science B.S. and MBA student at Syracuse University. I&apos;m currently in my fourth year of study and expect to graduate in December 2024.
              </span>
            </div>
